...
const RenderWidgetShell = (props) => {
    ...
    return ((0, jsx_runtime_1.jsxs)("div", { className: `fixed ${classes.containerClassName}`, children: [(0, jsx_runtime_1.jsx)("div", { className: `${classes.widgetContainerClassName} rounded-full bg-black flex items-center justify-center cursor-pointer`, onClick: () => setIsOpen(!isOpen), children: isOpen ? ((0, jsx_runtime_1.jsx)("div", { className: (0, classnames_1.default)('text-white fill-current pt-1', {
